...
(function() {
  ...
  rewrite.js = function(input) {
    var INPUT, comments, f, processComment, xxx, zzz;
    f = function(expr) {
      return "function() {\n  return " + expr + "\n}";
    };
    ...
    zzz = function(input, start, end) {
      var chars, chr, column, idx, line, lineNumber, state, _i, _j, _len, _len1, _ref, _ref1;
      state = 0;
      chars = [];
      _ref = input.split(/^/m);
      for (idx = _i = 0, _len = _ref.length; _i < _len; idx = ++_i) {
        ...
        lineNumber = idx + 1;
        _ref1 = line.split('');
        for (column = _j = 0, _len1 = _ref1.length; _j < _len1; column = ++_j) {
          chr = _ref1[column];
          if (state === 0) {
    ...
    return xxx = _.chain(comments).reduce(function(_arg, comment) {
      ...
      return [__slice.call(chunks).concat([zzz(INPUT, position, comment.loc.start)]), comment.loc.end];
    }, [
      [], {
        line: 1,
        column: 0
