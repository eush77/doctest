...
(function() {
  ...
  rewrite.coffee = function(input) {
    var comment, expr, idx, indent, line, lines, match, wrap, _i, _j, _len, _ref;
    wrap = {
      input: function(indent, expr) {
        return "" + indent + "__doctest.input ->\n" + indent + "  " + expr + "\n" + indent;
      },
      output: function(indent, expr, line) {
        return "" + indent + "__doctest.output " + line + ", ->\n" + indent + "  " + expr + "\n" + indent;
      }
    };
    lines = [];
    expr = '';
