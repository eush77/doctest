  ...
  f$ = function(comments) {
    return _.reduce(comments, function(_arg, comment) {
      ...
      return _.reduce(_.initial(comment.value.match(/(?!\s).*/g)), function(_arg1, line) {
        var accum, initial, input, lines, loc, location, prefix, state, _i, _ref;
        ...
        switch (state) {
          case 0:
            ...
            break;
          case 1:
            initial = 2 <= accum.length ? __slice.call(accum, 0, _i = accum.length - 1) : (_i = 0, []), (_ref = accum[_i++], loc = _ref.loc, input = _ref.input);
            if (prefix = _.first(/^>/.exec(line))) {
              return [
                __slice.call(accum).concat([{
                    loc: comment.loc,
              ...
              location = input.location, lines = input.lines;
              return [
